...
const ModernerKalender = dynamic(
    () => import("../../components/dashboard/outputs/ModernerKalender"),
    {ssr: false}
);
                    ...
                    {activeTab === "ziele" && (
                        <section className="animate-fade-in">
                            ...
                            <div className="grid gap-6 max-w-2xl">
                                {/* Trompete */}
                                <div
                                    className="p-6 rounded-3xl bg-gradient-to-br from-yellow-500/10 to-orange-500/10 border border-yellow-500/20 backdrop-blur-sm">
                                    <div className="flex items-center gap-4 mb-4">
                                        <div
                                            className="w-14 h-14 rounded-2xl bg-gradient-to-br from-yellow-500 to-orange-500 flex items-center justify-center text-2xl">
                                            🎺
                                        </div>
