        ...
        <div className="relative min-h-screen overflow-hidden bg-[#0a0a1f] text-white font-[system-ui]">
            ...
            <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-6">
                ...
                <div className="mb-8 animate-float relative group">
                    <div
                        className="absolute -inset-4 bg-gradient-to-r from-yellow-500 via-orange-500 to-yellow-600 rounded-3xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity animate-pulse"/>
                    <div
                        className="relative w-32 h-32 rounded-2xl bg-gradient-to-br from-yellow-400/10 via-orange-400/10 to-yellow-500/10 p-1 shadow-2xl shadow-yellow-500/50 backdrop-blur-sm border border-yellow-500/30">
                    ...
                    <div className="absolute inset-2 rounded-2xl border-2 border-orange-500/20 animate-spin-slow"
                ...
                Willkommen bei
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                            ...
                            <button
                                className="px-8 py-4 bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl font-semibold text-lg hover:bg-white/10 hover:scale-105 transition-all duration-300">
                                Mehr erfahren
                            </button>
                        </div>
                ...
                {showLogin && (
                    <div className="fixed inset-0 bg-black/60 backdrop-blur-xl flex items-center justify-center z-50 p-4 animate-fade-in">
                        <div
                            className="bg-gradient-to-br from-[#1a1a3e] to-[#0a0a1f] p-1 rounded-3xl max-w-md w-full shadow-2xl shadow-purple-500/20 animate-scale-in">
                            <div className="bg-[#0a0a1f] rounded-3xl p-8">
                                {/* Header */}
                                <div className="text-center mb-8">
                                    <div
                                        className="w-16 h-16 rounded-2xl bg-gradient-to-br from-purple-500 to-pink-500 p-1 mx-auto mb-4 shadow-lg shadow-purple-500/50">
                                ...
                                {loginMode === "admin" && (
                                    ...
                                    >
                                        ...
                                        {error && (
                                            <div
                                                className="p-3 bg-red-500/10 border border-red-500/30 rounded-xl text-red-400 text-sm text-center animate-shake">
                                                {error}
                                            </div>
                                        )}
            ...
            <footer className="relative z-10 py-8 text-center text-gray-500 text-sm">
                ...
                © 2025 LYRIONA. Crafted with 💜 V1.0
            </footer>
